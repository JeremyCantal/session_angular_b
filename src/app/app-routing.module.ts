...
import { RocketEditComponent } from './rockets/rocket-edit/rocket-edit.component';
...
//************************************************************************* 
  { path: 'rocket/:id', component: RocketDetailsComponent,  resolve:{ rocket : RocketDetailsResolver}  },
  { path: 'rocket/:id', component: RocketEditComponent },
//************************************************************************* 
